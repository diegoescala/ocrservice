...
var i_14512 = (self__.level + (1));
while(true){
if((i_14512 <= (new_level + (1)))){
(update[i_14512] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14514 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14514[i]));
} else {
x__$2.forward.push((((i < links_14514.length))?(links_14514[i]):null));
}

if((i < links_14514.length)){
(links_14514[i] = x__$2);
} else {
links_14514.push(x__$2);
}
...
var i_14519 = (0);
while(true){
if((i_14519 <= self__.level)){
var links_14520 = (update[i_14519]).forward;
if((x__$1 === (((i_14519 < links_14520.length))?(links_14520[i_14519]):null))){
(links_14520[i_14519] = (x__$1.forward[i_14519]));

var G__14522 = (i_14519 + (1));
i_14519 = G__14522;
continue;
} else {
...
if(cljs.core.truth_(nx)){
var G__14545 = nx;
var G__14546 = (level__$1 - (1));
x = G__14545;
level__$1 = G__14546;
continue;
} else {
var G__14547 = x;
var G__14548 = (level__$1 - (1));
x = G__14547;
level__$1 = G__14548;
continue;
}
