...
var fexpr__26918 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__26918.cljs$core$IFn$_invoke$arity$1 ? fexpr__26918.cljs$core$IFn$_invoke$arity$1(type) : fexpr__26918.call(null, type));
});
...
var G__26951 = spec_tools.impl.normalize_symbol(x);
var G__26952 = null;
var G__26953 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__26951,G__26952,G__26953) : spec_tools.parse.parse_form.call(null, G__26951,G__26952,G__26953));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__26954 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__26955 = x;
var G__26956 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__26954,G__26955,G__26956) : spec_tools.parse.parse_form.call(null, G__26954,G__26955,G__26956));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__27082 = cljs.spec.alpha.form(x);
var G__27083 = options;
x = G__27082;
options = G__27083;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__26957 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__26958 = null;
var G__26959 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__26957,G__26958,G__26959) : spec_tools.parse.parse_form.call(null, G__26957,G__26958,G__26959));
} else {
...
var G__26960 = parse_data;
var G__26960__$1 = (((G__26960 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__26960));
var G__26960__$2 = (((G__26960__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__26960__$1));
var G__26960__$3 = (((G__26960__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__26960__$2));
var G__26960__$4 = (((G__26960__$3 == null))?null:cljs.core.seq(G__26960__$3));
if((G__26960__$4 == null)){
return null;
} else {
return cljs.core.set(G__26960__$4);
}
}
});
...
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__26961 = cljs.core.get_global_hierarchy;
return (fexpr__26961.cljs$core$IFn$_invoke$arity$0 ? fexpr__26961.cljs$core$IFn$_invoke$arity$0() : fexpr__26961.call(null, ));
})());
...
var map__27018 = spec_tools.impl.parse_keys(form);
var map__27018__$1 = cljs.core.__destructure_map(map__27018);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27018__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27018__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27018__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27018__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27018__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__27019 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__27019__$1 = (cljs.core.truth_((function (){var or__5002__auto__ = req;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27019,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__27019);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27019__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__27019__$1;
}
}));
...
var vec__27020 = multi_spec_form;
var seq__27021 = cljs.core.seq(vec__27020);
var first__27022 = cljs.core.first(seq__27021);
var seq__27021__$1 = cljs.core.next(seq__27021);
var _ = first__27022;
var first__27022__$1 = cljs.core.first(seq__27021__$1);
var seq__27021__$2 = cljs.core.next(seq__27021__$1);
var multi_method_symbol = first__27022__$1;
var ___$1 = seq__27021__$2;
var form = vec__27020;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__27023){
var vec__27024 = p__27023;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27024,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27024,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__27027_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__27027_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__27028_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__27028_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__27029_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__27029_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27030_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__27030_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__27031 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__27031__$1 = cljs.core.__destructure_map(map__27031);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27031__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__27032 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__27032__$1 = cljs.core.__destructure_map(map__27032);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27032__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__27035,options){
var vec__27036 = p__27035;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27036,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27036,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27036,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__27040,options){
...
var ___$1 = first__27043;
var values = seq__27042__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__27039_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__27039_SHARP_,options);
}),values);
...
var type_priority = (function (p1__27056_SHARP_){
var G__27059 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__27058 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__27056_SHARP_);
return (fexpr__27058.cljs$core$IFn$_invoke$arity$1 ? fexpr__27058.cljs$core$IFn$_invoke$arity$1(G__27059) : fexpr__27058.call(null, G__27059));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27057_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__27057_SHARP_,options);
}),cljs.core.rest(form))));
}));
