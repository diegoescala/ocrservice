...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_24651 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_24651(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_24652 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_24652(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24654 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24654(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24655 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24655(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24656 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24656(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24657 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24657(reader);
}
});
...
var G__24666 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__24667 = s.append(c);
c = G__24666;
s = G__24667;
continue;
}
