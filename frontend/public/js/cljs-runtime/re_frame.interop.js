...
return [(function (){var pred__22158 = cljs.core.instance_QMARK_;
var expr__22159 = reactive_val;
if(cljs.core.truth_((pred__22158.cljs$core$IFn$_invoke$arity$2 ? pred__22158.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__22159) : pred__22158.call(null, reagent.ratom.RAtom,expr__22159)))){
return "ra";
} else {
if(cljs.core.truth_((pred__22158.cljs$core$IFn$_invoke$arity$2 ? pred__22158.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__22159) : pred__22158.call(null, reagent.ratom.RCursor,expr__22159)))){
return "rc";
} else {
if(cljs.core.truth_((pred__22158.cljs$core$IFn$_invoke$arity$2 ? pred__22158.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__22159) : pred__22158.call(null, reagent.ratom.Reaction,expr__22159)))){
return "rx";
} else {
if(cljs.core.truth_((pred__22158.cljs$core$IFn$_invoke$arity$2 ? pred__22158.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__22159) : pred__22158.call(null, reagent.ratom.Track,expr__22159)))){
return "tr";
} else {
return "other";
}
