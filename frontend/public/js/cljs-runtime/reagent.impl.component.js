...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21842 = c;
var G__21842__$1 = (((G__21842 == null))?null:G__21842.prototype);
if((G__21842__$1 == null)){
return null;
} else {
return G__21842__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21843 = c;
var G__21843__$1 = (((G__21843 == null))?null:G__21843.prototype);
if((G__21843__$1 == null)){
return null;
} else {
return G__21843__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__21851 = c;
var G__21851__$1 = (((G__21851 == null))?null:G__21851.constructor);
if((G__21851__$1 == null)){
return null;
} else {
return G__21851__$1.displayName;
}
})();
...
var G__21852 = c;
var G__21852__$1 = (((G__21852 == null))?null:G__21852.constructor);
if((G__21852__$1 == null)){
return null;
} else {
return G__21852__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21855 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21856 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21856);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21855);
}});
...
var c = this;
var G__21914_21947 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21914_21947 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21914_21947);
}
...
var renders_21948 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21949 = cljs.core.first(cljs.core.vals(renders_21948));
...
if((cljs.core.count(renders_21948) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_21948))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_21949)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21949], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21928 = o;
reagent.impl.component.goog$module$goog$object.set(G__21928,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21929 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21930 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21930);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21929);
}});
...
var vec__21931 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21931,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21931,(1),null);
...
var G__21934 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21934 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21934);
}
});
}),[]);
